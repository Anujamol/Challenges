...
import 'package:task/mychlng_sub.dart';

class MyChlngDetScreen extends StatelessWidget {
  const MyChlngDetScreen({super.key});
  @override
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const MyChlngSubScreen()),
                  );
                },
                child: Padding(
