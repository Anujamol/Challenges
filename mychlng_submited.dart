...
import 'package:task/mychlng_submtd_exp.dart';

class MyChlngSubmitedScreen extends StatelessWidget {
  const MyChlngSubmitedScreen({super.key});
 @override
            ...
            children: [
              ...
              const SizedBox(height: 22,),
                           const Padding(
                             ...
                             child: Text('Challenge Status',style: TextStyle(
                        ...
                        bottomLeft: Radius.circular(20),
                         ...
                         const SizedBox(height: 60,),
                           const Padding(
                             ...
                             child: Text('Application Category',style: TextStyle(
                                                   color: Color(0xffEA4335),
                                                   fontSize: 12,
                                                   fontWeight: FontWeight.w700,
                                                 ),
                   ...
                   Padding(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        const Padding(
                          padding: EdgeInsets.only(right: 40, top: 3),
                          child: Text(
                        ...
                        Padding(
                          padding: const EdgeInsets.only(right: 115, top: 3),
                          child: Container(
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const MyChlngSubExpScreen()),
                          );
                        },
                        child: Icon(
