...
import 'package:task/leader_board2.dart';
import 'package:task/practice_leader2.dart';

class PracticeLeaderScrn extends StatelessWidget {
  const PracticeLeaderScrn({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const Leaderboadrdscrn ()),
        );
          },
                   child:  Padding(
  ...
  child: ClipRRect(
    child: InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => const ChlngsHomeScreen()),
        );
      },
      child: Image.asset(
  ...
  onTap: () {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const PracticeLeaderScrn2()),
    );
  },
  child: Padding(
            ...
            mainAxisAlignment: MainAxisAlignment.start,
             children: [
               Padding(
                 ...
                 child: Text('Live Competition',style: TextStyle(
                  fontSize: 16,
                  color: Color(0xff3A0070),
                  fontWeight: FontWeight.w700
                 ),),
